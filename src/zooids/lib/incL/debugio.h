 ...
 */
int debug_vfprintf(DEBUG_FILE *stream, const char *format, va_list __va_list);
...
/*! \brief Formatted write \ingroup Debug Terminal Output Functions \synopsis
  ...
  rather than a variable number of arguments.
*/
int debug_vprintf(const char *format, va_list __va_list);
...
/*! \brief Formatted read \ingroup File Functions \synopsis
  ...
  rather than a variable number of arguments.
*/
int debug_vfscanf(DEBUG_FILE *stream, const char *format, va_list __va_list);
...
/*! \brief Formatted read \ingroup Debug Terminal Input Functions \synopsis
  ...
  rather than a variable number of arguments.
*/
int debug_vscanf(const char *format, va_list __va_list);
