...
set(AVR_CFLAGS "-std=c99 -mmcu=${AVR_MCU} -Wall -Wno-comment -Os -funsigned-char -funsigned-bitfields -fpack-struct -fshort-enums -fno-strict-aliasing -ffunction-sections -fdata-sections -DF_CPU=8000000")
if (DEBUG)
    set(AVR_LDFLAGS "-mmcu=${AVR_MCU} -g")
else()
...
option(BBZ_ENABLE_FLOATS_OPERATIONS "Whether to enable floats operations" OFF)
