...
set(CMAKE_SYSTEM_PROCESSOR STM32F072)
...
set(INCLUDE_DIR "-I${ZOOIDS_LIB_DIR}/incL -I${ZOOIDS_LIB_DIR}/inc -I${ZOOIDS_DRIVER_DIR}/CMSIS/Include -I${ZOOIDS_DRIVER_DIR}/CMSIS/Device/ST/STM32F0xx/Include -I${ZOOIDS_DRIVER_DIR}/STM32F0xx_HAL_Driver/Inc -I${ZOOIDS_DRIVER_DIR}/BSP/STM32072B_EVAL -I${ZOOIDS_DRIVER_DIR}/BSP/Components/Common")
...
set(CFLAGS "-Os -std=gnu99 -g -mthumb -mcpu=cortex-m0 -msoft-float")
...
set(CFLAGS "${CFLAGS} -funsigned-char -funsigned-bitfields -fpack-struct -fshort-enums -fno-strict-aliasing -ffunction-sections -fdata-sections")

set(LDFLAGS "--static -nostartfiles -mthumb -mcpu=cortex-m0 -msoft-float")
set(LDSCRIPT "-T${LINKER_SCRIPT}")
set(LDFLAGS "${LDFLAGS} -Wl,--gc-sections ${LIBS}")
# LDLIBS
set(LDLIBS "${LDFLAGS} -Wl,--start-group -lm -Wl,--end-group")
...
set(NATIVE_C_FLAGS "${CFLAGS}" CACHE STRING "GCC flags for the native compiler." FORCE)
