...
set(INCLUDE_DIR "-I${ZOOIDS_LIB_DIR}/incL -I${ZOOIDS_LIB_DIR}/inc -I${ZOOIDS_DRIVER_DIR}/CMSIS/Include -I${ZOOIDS_DRIVER_DIR}/CMSIS/Device/ST/STM32F0xx/Include -I${ZOOIDS_DRIVER_DIR}/STM32F0xx_HAL_Driver/Inc -I${ZOOIDS_DRIVER_DIR}/BSP/STM32072B_EVAL -I${ZOOIDS_DRIVER_DIR}/BSP/Components/Common -I${CMAKE_SOURCE_DIR} -I${CMAKE_BINARY_DIR} -I${CMAKE_BINARY_DIR}/zooids/lib/inc")
...
set(LDSCRIPT "")
set(LDFLAGS "${LDFLAGS} -Wl,--gc-sections ${LIBS} ${ZOOIDS_LIB_DIR}/linker/startup_stm32f0xx.S")
# LDLIBS
