...
printf "\tCheck for buzz assembler... "
if [ -z "$BZZ_ASM" ]; then
...
echo "Done $BO2BBO_PATH"

printf "\tCheck for kilo_bcodegen... "
...
echo "Done $KILO_SYMGEN_PATH"

printf "\tCheck for BittyBuzz library... "
...
echo "Done $BBZ_LIB_DIR/lib$BBZ_LIB_NAME.a"

printf "\tCheck for KiloLib library... "
...
echo "Done $KILOLIB_DIR/lib$KILOLIB_NAME.a"
...
echo "Compiling and Linking c functions..."
