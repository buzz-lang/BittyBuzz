 ...
 * We send less messages if we don't have enough info to send
 */
...
//  * before it is completely forgotten. A value greater than or equal to
//  * 256 will make the entry remain inactive without ever being deleted.
//  */
